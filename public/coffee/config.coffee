require.config
  ...
  paths:
    ...
    'jquery.ui.widget': '../components/external/blueimp-file-upload/js' +
      '/vendor/jquery.ui.widget'
    iframe_transport: '../components/external/blueimp-file-upload/js' +
      '/jquery.iframe-transport'
    fileupload: '../components/external/blueimp-file-upload/js/' +
      'jquery.fileupload'

    placeholder: '../components/external/Placeholders.js/build/' +
      'placeholders.jquery'
    bezier: '../components/local/jquery.path/jquery.path'
    socialshare: '../components/local/SocialSharePrivacy/javascripts/' +
      'jquery.socialshareprivacy.min'
    socialshare_de: '../components/local/SocialSharePrivacy/' +
      'javascripts/jquery.socialshareprivacy.min.de'
    socialshare_ru: '../components/local/SocialSharePrivacy/' +
      'javascripts/jquery.socialshareprivacy.min.ru'
  ...
  # Определяем плагины и модули которые написаны не как AMD модули
  shim:
    hashchange: ['jquery']
    flexslider: ['jquery']
    sticky: ['jquery']
